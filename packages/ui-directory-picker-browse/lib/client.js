window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/data/data/com.termux/files/home/deepseek-harness/packages/client/ui-directory-picker-browse/src/client/DirectoryBrowser.module.css.mjs
		const css = ".TOdKkW_dialog.TOdKkW_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.TOdKkW_editorScope{display:contents}.TOdKkW_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.TOdKkW_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.TOdKkW_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.TOdKkW_crumbBar:has(.TOdKkW_crumbEditZone:enabled:hover),.TOdKkW_crumbBar:has(.TOdKkW_crumbEditZone:focus-visible),.TOdKkW_crumbBar:has(.TOdKkW_pathInput){border-color:var(--dsw-alias-border-l2)}.TOdKkW_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.TOdKkW_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.TOdKkW_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.TOdKkW_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.TOdKkW_crumb:hover{color:var(--dsw-alias-label-primary)}.TOdKkW_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.TOdKkW_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.TOdKkW_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.TOdKkW_crumbEditZone:enabled:hover .TOdKkW_crumbEditGlyph,.TOdKkW_crumbEditZone:focus-visible .TOdKkW_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.TOdKkW_crumbEditZone:disabled{cursor:default}.TOdKkW_crumbEditZone:disabled .TOdKkW_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.TOdKkW_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.TOdKkW_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.TOdKkW_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.TOdKkW_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.TOdKkW_rowSeat{flex:none;display:flex}.TOdKkW_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.TOdKkW_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.TOdKkW_rowSelected,.TOdKkW_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.TOdKkW_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.TOdKkW_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.TOdKkW_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.TOdKkW_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.TOdKkW_status,.TOdKkW_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.TOdKkW_status{color:var(--dsw-alias-label-secondary)}.TOdKkW_error{color:var(--dsw-alias-state-error-primary)}.TOdKkW_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.TOdKkW_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.TOdKkW_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.TOdKkW_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.TOdKkW_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.TOdKkW_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.TOdKkW_footerGap{flex:1 1 0}.TOdKkW_footerAction{min-width:72px}.TOdKkW_createDialog.TOdKkW_createDialog{gap:0;width:min(380px,100%);padding:0}.TOdKkW_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.TOdKkW_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.TOdKkW_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.TOdKkW_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.TOdKkW_createInput::placeholder{color:var(--dsw-alias-label-caption)}.TOdKkW_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"column": "TOdKkW_column",
			"content": "TOdKkW_content",
			"createActions": "TOdKkW_createActions",
			"createBody": "TOdKkW_createBody",
			"createDialog": "TOdKkW_createDialog",
			"createIn": "TOdKkW_createIn",
			"createInput": "TOdKkW_createInput",
			"createTitle": "TOdKkW_createTitle",
			"crumb": "TOdKkW_crumb",
			"crumbBar": "TOdKkW_crumbBar",
			"crumbChevron": "TOdKkW_crumbChevron",
			"crumbEditGlyph": "TOdKkW_crumbEditGlyph",
			"crumbEditZone": "TOdKkW_crumbEditZone",
			"crumbSeat": "TOdKkW_crumbSeat",
			"crumbTrail": "TOdKkW_crumbTrail",
			"dialog": "TOdKkW_dialog",
			"divider": "TOdKkW_divider",
			"editorScope": "TOdKkW_editorScope",
			"error": "TOdKkW_error",
			"footerAction": "TOdKkW_footerAction",
			"footerBar": "TOdKkW_footerBar",
			"footerGap": "TOdKkW_footerGap",
			"header": "TOdKkW_header",
			"loadingFloat": "TOdKkW_loadingFloat",
			"millerRow": "TOdKkW_millerRow",
			"pathInput": "TOdKkW_pathInput",
			"row": "TOdKkW_row",
			"rowChevron": "TOdKkW_rowChevron",
			"rowIcon": "TOdKkW_rowIcon",
			"rowIconSelected": "TOdKkW_rowIconSelected",
			"rowName": "TOdKkW_rowName",
			"rowSeat": "TOdKkW_rowSeat",
			"rowSelected": "TOdKkW_rowSelected",
			"showHiddenToggle": "TOdKkW_showHiddenToggle",
			"showHiddenToggleActive": "TOdKkW_showHiddenToggleActive",
			"status": "TOdKkW_status",
			"title": "TOdKkW_title"
		};
		//#endregion
